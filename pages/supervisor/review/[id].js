...
import { ROLES, ADMIN_ROLES, VISUAL_CHECKLIST_ITEMS, INSPECTION_STATUS, VEHICLE_LANES, LANE_TYPES } from '../../../lib/constants';
  ...
  async function saveVehicleData() {
    ...
    try {
      ...
      if (!vRes.ok) {
        ...
        console.error('Failed to save vehicle data:', vData.error || vRes.status);
      }
    } catch (e) {
...
export default withAuth(SupervisorReview, [ROLES.SUPERVISOR, ...ADMIN_ROLES]);
