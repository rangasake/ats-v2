...
// ─── Vehicle Lanes ────────────────────────────────────────────────────────────
export const VEHICLE_LANES = ['LMV', 'HMV', 'MMV', 'A/R-Cab'];
...
export const SHEETS = {
  ...
  AUDIT_LOG:           'AuditLog',
  CONFIG:              'Config',        // org-specific key/value settings
  SUPERADMINS:         'SuperAdmins',   // credentials for the superadmin portal
  ORGS:                'orgs',          // org registry in SuperAdmin sheet
};