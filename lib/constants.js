...
export const MANDAL_RTO_MAP = {
  ...
  KOTHAPETA: 'AMALAPURAM',
  ALAMURU: 'MANDAPETA',
  MUMMIDIVARAM: 'AMALAPURAM',
  RAMACHANDRAPURAM: 'AMALAPURAM',
  AINAVILLI: 'AMALAPURAM',
  UPPALAGUPTAM: 'AMALAPURAM',
  KATRENIKONA: 'AMALAPURAM',
  MALIKIPURAM: 'AMALAPURAM',
  RAZOLE: 'AMALAPURAM',
  MORAMPUDI: 'RAJAMAHENDRAVARAM',
  KOVVUR: 'RAJAMAHENDRAVARAM',
  NIDADAVOLU: 'RAJAMAHENDRAVARAM',
  TANUKU: 'TANUKU',
  BHIMAVARAM: 'BHIMAVARAM',
  NARASAPUR: 'BHIMAVARAM',
  PALAKOL: 'BHIMAVARAM',
  UNDI: 'BHIMAVARAM',
  ELURU: 'ELURU',
  DENDULURU: 'ELURU',
...
// ─── Vehicle Lanes ────────────────────────────────────────────────────────────
export const VEHICLE_LANES = ['LMV', 'HMV', 'MMV'];
...
export const SHEETS = {
  ...
  STAFF: 'Staff',
  AGENTS: 'Agents',
  DEVICES: 'Devices',   // ← NEW: device token management
};